...
# ✨ CORRECCIÓN: Inicializamos los DataFrames aquí, fuera de la barra lateral.
# De esta forma, las variables df_energy y df_weather_raw siempre existen en el script.
...
with st.sidebar:
    ...
    if not df_energy_raw.empty:
        try:
            # Ahora modificamos la variable df_energy que ya existe
            ...
            df_energy = pd.DataFrame() # En caso de error, lo reseteamos a vacío

# --- Panel Principal ---
st.title("Dashboard de Análisis de Consumo Energético")

# Esta línea ahora funciona porque df_energy fue creada al principio del script
